...
The starter kit ships with a **Duplex Apartment** IFC model -- a realistic two-storey residential building with 14 doors, 24 windows, 57 walls, 21 spaces, and 2 staircases. This is your main testing ground.

The kinds of questions you will answer programmatically range in complexity:
...
As you build confidence, you can test against additional IFC models from other sources to see how your checks handle different vendors and modeling styles.
...
The checks you build during the course each demonstrate different aspects of IFC data access:

| Check Example | What It Queries | Key Challenge |
|---|---|---|
...
The tool for reading IFC files in Python is **ifcopenshell**. The starter kit includes a Duplex Apartment model for practicing.
